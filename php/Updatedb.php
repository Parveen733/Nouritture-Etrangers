...
if ( $result->num_rows > 0 ) {
   ...
   header("location: Recipeerror.php");
    ...
    $sql = "UPDATE recipe SET Recipe_Name='$Recipename',Recipe_Desc='$RecipeDesc',Recipe_Ingrediants='$ingrediants',Recipe_Method='$method',Recipe_category='$category',usr_id='$usr_id',Recipe_Image='$avatar_path' WHERE Recipe_Id='$RecipeID'";
