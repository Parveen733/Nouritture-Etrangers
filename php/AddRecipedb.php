...
if ( $result->num_rows > 0 ) {
   ...
   header("location: error.php");
    ...
    $sql = "INSERT INTO recipe (Recipe_Name,Recipe_Desc,Recipe_Ingrediants,Recipe_Method,Recipe_category,usr_id,Recipe_Image) VALUES ('$Recipename','$RecipeDesc','$ingrediants','$method','$category','$usr_id','$avatar_path')";
